 ...
 */
public class FragmentLlistat extends Fragment implements View.OnClickListener {
    ...
    public static FragmentLlistat newInstance(String param1, String param2)  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_fragment_llistat, container, false);
